# Introducción a los Geomorfositios
...
### Valores de un geomorfositio

Kubalíková (2013) cita a Reynard, Coratza y Regolini-Bissing (2009) quienes describen que los valores de los geomorfositios se dividen en dos grupos:

1. **Valores científicos**: su importancia radica en entender la forma, procesos y evolución del geomorfositio. Entre los principales valores científicos que poseen destacan la *representatividad del sitio*, *la forma*, *proceso*, *singularidad* y *la importancia paleogeográfica*.
2. **Valores añadidos**: está representado por todos los atributos considerados intangibles donde los más relevantes son: *valor cultural*, *valor estético*, *valor ecológico*, *valor económico/social*.

#### Caracterización de los valores científicos de un geomorfositio
...
**Figura 1**: Cráter principal del volcán Poás (Fuente: [Pérez-Umaña, 2017](https://www.researchgate.net/publication/317416379_Evaluacion_del_potencial_turistico_de_geomorfositios_del_Parque_Nacional_Volcan_Poas)).
...
En este apartado se describen aquellos valores y caracteristicas que las personas les han dado a los lugares de interés geomorfológico (Serrano y González, 2005), los cuales son intangibles y no pueden ser cuantificados. Los principales valores añadidos son los siguientes:

* *Valor cultural*, representado por la importancia arqueológica, histórica o religiosa del sitio relacionada con las características físicas del lugar. Un ejemplo de esto se observa en muchos lugares del mundo. Nuevamente, tomando como referencia el volcán Paricutín, donde anualmente se realizan romerías para visitar el [templo de San Juan Parangaricutiro](https://www.gob.mx/cenapred/es/articulos/el-paricutin-vida-efimera-de-un-volcan), el cual fue destruido por las erupciones de este volcán y donde solo su campanario y parte del templo aun siguen en pie (Figura 3).

![San Juan Parangaricutiro](https://www.gob.mx/cms/uploads/article/main_image/153722/1.jpg)
**Figura 3**: Templo de San Juan Parangaricutiro, lo único que sobrevivió a las erupciones del volcán Paricutín (Fuente: [Centro Nacional de Prevención de Desastres, 2025](https://www.gob.mx/cenapred/es/articulos/el-paricutin-vida-efimera-de-un-volcan)).

* *Valor estético*: basado en el contraste de colores, estructura del espacio y la heterogeneidad del lugar, también se relaciona con el valor estético y el valor paisajistico. Un ejemplo del valor ecológico es la [Montaña de los Siete Colores en Perú](https://viajes.nationalgeographic.com.es/ubicacion-exacta/montana-siete-colores_17817) cuya variedad de colores y belleza escénica la ha convertido en un sitio de interés para visitar (Figura 4).

![Montaña de los siete colores](https://content-viajes.nationalgeographic.com.es/medio/2022/02/15/vinicunca_767e250c_1254x836.jpg)
...
En Costa Rica se han realizado muchos trabajos cuya temática han sido los geomorfositios. No obstante, hay que contabilizar cuantos trabajos hay, que metodologías se han utilizado, la cantidad de geomorfositios se han identificado y que instrumentos de difusión hay para conocer sobre estos lugares de interés geomorfológico.

Es una tarea que, se pretende ir resolviendo, por lo que como parte de estos trabajos se ahondará en el tema con fines de divulgar a todas las personas que conocimientos hay en torno a los geomorfositios en Costa Rica.
